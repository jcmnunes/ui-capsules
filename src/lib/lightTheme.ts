...
export const lightTheme = createTheme({
  colors: {
    ...
    tertiary500: '$yellow500',
    tertiary600: '$yellow600',
    tertiary700: '$yellow700',
    tertiary800: '$yellow800',
    tertiary900: '$yellow900',
  ...
  shadows: {
    ...
    border: 'inset 0px 0px 0px 1px $colors$neutral400',
    borderPrimary: 'inset 0px 0px 0px 1px $colors$primary500',
    borderError: 'inset 0px 0px 0px 1px $colors$error500',
    borderErrorHover: 'inset 0px 0px 0px 1px $colors$error600',
    borderSuccess: 'inset 0px 0px 0px 1px $colors$success500',
    borderSuccessHover: 'inset 0px 0px 0px 1px $colors$success600',
    borderHover: 'inset 0px 0px 0px 1px $colors$neutral500',
